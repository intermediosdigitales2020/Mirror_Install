...
stop2)
	dbus-send --print-reply=literal --session --dest=org.mpris.MediaPlayer2.omxplayer2 /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.Action int32:15 >/dev/null
	;;
...
hidevideo2)
	dbus-send --print-reply=literal --session --dest=org.mpris.MediaPlayer2.omxplayer2 /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.Action int32:28 >/dev/null
	;;

unhidevideo2)
	dbus-send --print-reply=literal --session --dest=org.mpris.MediaPlayer2.omxplayer2 /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.Action int32:29 >/dev/null
	;;
